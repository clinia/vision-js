 ...
 * from Clinia servers. This can be configured on the Vision constructor with the property
 ...
 * var customSearchBox = vision.connectors.connectSearchBox(renderFn);
 *
...
export default function connectSearchBox(renderFn, unmountFn = noop) {
  ...
  return (widgetParams = {}) => {
    ...
    return {
      ...
      render({ helper, visionInstance, searchMetadata }) {
        this._clear = clear(helper);
