...
export { default as hasDetectedInsightsClient } from './detect-insights-client';
...
export { addAbsolutePosition } from './records-absolute-position';
export { addQueryID } from './records-query-id';
