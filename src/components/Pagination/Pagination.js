...
class Pagination extends Component {
  ...
  previousPageLink({ isFirstPage, currentPage, createURL }) {
    return this.pageLink({
      ...
      isDisabled: this.props.total === 0 || isFirstPage,
  ...
  nextPageLink({ isLastPage, currentPage, createURL }) {
    return this.pageLink({
      ...
      isDisabled: this.props.total === 0 || isLastPage,
  ...
  lastPageLink({ isLastPage, numPages, createURL }) {
    return this.pageLink({
      ariaLabel: 'Last',
    ...
    return (
      <div
        className={cx(this.props.cssClasses.root, {
          [this.props.cssClasses.noRefinementRoot]: this.props.numPages <= 1,
        })}
      >
