...
describe('GeoSearch', () => {
  ...
  const createFakeVision = () => ({ templatesConfig: undefined });
  ...
  it('expect to render', () => {
    ...
    const visionInstance = createFakeVision();
    ...
    expect(firstRender[1]).toBe(container.querySelector('.cvi-GeoSearch-tree'));
  });
  ...
  describe('markers creation', () => {
    it('expect to render built-in markers with default options', () => {
      ...
      widget.render({
        ...
        results: {
          records: [
            { id: 123, geoPoint: true },
            { id: 456, geoPoint: true },
            { id: 789, geoPoint: true },
          ],
        },
      });
    ...
    it('expect to setup listeners on built-in markers', () => {
      ...
      widget.render({
        ...
        results: {
          records: [
            { id: 123, geoPoint: true },
            { id: 234, geoPoint: true },
            { id: 789, geoPoint: true },
          ],
        },
      });

      // 2 events for each record
